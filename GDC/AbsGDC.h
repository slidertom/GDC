...
public:
    ...
    virtual void DrawTextByEllipse(double dCenterAngle, int32_t nRadiusX, int32_t nRadiusY, int32_t xCenter, int32_t yCenter, const wchar_t *sText, double dEllipseAngleRad, const GDCPaint &paint) = 0;
    virtual void DrawTextByCircle(double dCenterAngle, int32_t nRadius, int32_t nCX, int32_t nCY, const wchar_t *sText, bool bRevertTextDir, const GDCPaint &paint) = 0;
