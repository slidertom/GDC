...
public:
    ...
    virtual void DrawTextByCircle(double dCenterAngle, int32_t nRadius, int32_t nCX, int32_t nCY, 
                                  const wchar_t *sText, bool bRevertTextDir, const GDCPaint &paint) override;
